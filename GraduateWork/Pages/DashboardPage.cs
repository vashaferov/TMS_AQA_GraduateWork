...
public class DashboardPage : BasePage
{
    ...
    public UIElement LimitValuesErrorMessage => new UIElement(_driver, LimitValuesErrorMessageBy);
    ...
    public void ClearAndSend(string text)
    {
        ProjectNameInput.Clear();
        ProjectNameInput.SendKeys(text);
    }
